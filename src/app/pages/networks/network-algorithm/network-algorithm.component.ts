...
import { GoogleMapsModule } from '@angular/google-maps'; // Import for standalone
...
@Component({
  selector: 'ngx-network-algorithm',
  templateUrl: './network-algorithm.component.html',
  styleUrls: ['./network-algorithm.component.scss']
})
export class NetworkAlgorithmComponent {
