...
@Component({
  selector: 'ngx-cluster-algorithms',
  templateUrl: './cluster-algorithms.component.html',
  styleUrls: ['./cluster-algorithms.component.scss']
})
export class ClusterAlgorithmsComponent {
component:string = 'Cluster-algorithms'
url: string =  'cluster_algorithms/';
settings = {
    add: {
    ...
    columns: {
      ...
      type: 'html',
        ...
        return `<a href="pages/cluster-algorithm/${row.id}">${name}</a>`;
      }
      },
      description: {
        title: 'Description',
