...
@Component({
  selector: 'ngx-edge-algorithms',
  templateUrl: './edge-algorithms.component.html',
  styleUrls: ['./edge-algorithms.component.scss']
})
export class EdgeAlgorithmsComponent {
url: string =  'edge_algorithms/';
link: string = 'edge_algorithms';
settings = {
    add: {
